...
class ApiTrainsetAttachmentController extends Controller {
    ...
    public function index(Request $request) {
        ...
        switch ($intent) {
            case IntentEnum::API_TRAINSET_ATTACHMENT_GET_ATTACHMENTS_BY_STATUS->value:
                ...
                if (!in_array($status, array_column(TrainsetAttachmentStatusEnum::cases(), 'value'), true)) {
     ...
     */
    public function update(UpdateTrainsetAttachmentRequest $request, TrainsetAttachment $trainset) {
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy(TrainsetAttachment $trainset) {
        //
    }
}