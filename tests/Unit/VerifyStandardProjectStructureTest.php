...
test('model should have controllers, form request, resource, service interface, repository interface, service, and repository', function () use ($excludedControllers, $excludedRequests, $excludedRepositories, $excludedServices, $excludedReactModelInterfaces, $excludedReactResources, $excludedReactServices) {
    $baseDir = realpath(__DIR__ . '/../../'); // Adjust to get the project root directory
...
test('detect extra files and anomalies in project structure', function () use ($excludedControllers, $excludedRequests, $excludedRepositories, $excludedServices) {
    $baseDir = realpath(__DIR__ . '/../../'); // Adjust to get the project root directory
