const intents = {
    ...
    WEB_TRAINSET_ATTACHMENT_GET_ATTACHMENT_COMPONENTS:
        'web.trainset.attachment.get.attachment.components',
    ...
    WEB_DASHBOARD_GET_REPLACEMENT_STOCK_THRESHOLD: 'web.dashboard.get.replacement.stock.threshold',
