    ...
    return (
        <Dialog>
            ...
            <DialogContent className='sm:max-w-[425px]'>
                <DialogHeader>
                    <DialogTitle>{t('pages.replacement_stock.partials.import.dialogs.title')}</DialogTitle>
                    <DialogDescription>
                ...
                <div className='flex flex-col space-y-4'>
                    <Label>
                        {t('pages.replacement_stock.partials.import.dialogs.fields.download_template')}
                    </Label>
                    <Button
                        variant='secondary'
                        type='button'
                    ...
                    >
                        {loading
                            ? t('action.loading')
                            : t('pages.replacement_stock.partials.import.dialogs.buttons.download_template')}
                    </Button>
                </div>
                <form onSubmit={handleImportData} className='space-y-4'>
                    ...
                    <DialogFooter>
                        <Button type='submit' disabled={loading}>
                            {loading
                                ? t('action.loading')
                                : t('pages.replacement_stock.partials.import.dialogs.buttons.import')}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
