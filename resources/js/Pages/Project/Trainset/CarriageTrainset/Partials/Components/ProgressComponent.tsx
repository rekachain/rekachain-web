                ...
                (trainsetAttachmentProgress.length === 0 && 
                    ...
                    trainsetAttachmentProgress.map((progress) => (
                        <div key={progress.component.id}>
                            <h4 className="text-lg font-bold">{t('pages.project.trainset.carriage_trainset.partials.components.progress_component.props.component', { component: progress.component.name})}</h4>
                                    ...
                                    <div key={`${componentProgress.carriage_panel_component_id}`}>
                                        <div className="flex items-center justify-center space-x-2 pb-1">
                                            <div className="flex-1">
                                                <h3 className="text-right">{t('pages.project.trainset.carriage_trainset.partials.components.progress_component.props.panel', { panel: componentProgress.panel.name})}</h3>
                                            </div>
                                            <div className="flex-none">
                                                <h3 className="text-center">|</h3>
                                            </div>
                                            <div className="flex-1">
                                                <h3 className="text-left">{t('pages.project.trainset.carriage_trainset.partials.components.progress_component.props.carriage', { carriage: componentProgress.carriage.type})}</h3>
                                            </div>
                                        </div>
                                                            ...
                                                            <BreadcrumbItem>
                                                                <Popover modal>
                                                                    ...
                                                                    <PopoverContent className='flex flex-col gap-2'>
                                                                        <h4 className="text-lg font-bold">{t('pages.project.trainset.carriage_trainset.partials.components.progress_component.props.workers')}</h4>
