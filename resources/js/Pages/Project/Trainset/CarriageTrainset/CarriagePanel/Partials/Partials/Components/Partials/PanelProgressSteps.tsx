...
export default function ({
    ...
    const handleAddStep = withLoading(async (e: FormEvent<HTMLDivElement>) => {
        ...
        void useSuccessToast(
            t(
                'pages.project.trainset.carriage_trainset.carriage_panel.partials.partials.components.partials.panel_progress_steps.messages.updated',
            ),
        );
    }, true);
    ...
    const handleProgressStepDeletion = withLoading(async (progressStepId: number) => {
        ...
        void useSuccessToast(
            t(
                'pages.project.trainset.carriage_trainset.carriage_panel.partials.partials.components.partials.panel_progress_steps.messages.deleted',
            ),
        );
    }, true);
                ...
                <div className='mt-4 flex flex-col gap-4 bg-background-2 p-4'>
                    ...
                    <div className='flex items-center'>
                        <GenericDataSelector
                            ...
                            placeholder={t(
                                'pages.project.trainset.carriage_trainset.carriage_panel.partials.partials.components.partials.panel_progress_steps.fields.step_placeholder',
                            )}
