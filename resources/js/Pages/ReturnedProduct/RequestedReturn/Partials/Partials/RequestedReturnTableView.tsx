            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead>{t('pages.returned_product.partials.partials.returned_product_table.headers.created_at')}</TableHead>
                        <TableHead>{t('pages.returned_product.partials.partials.returned_product_table.headers.updated_at')}</TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
