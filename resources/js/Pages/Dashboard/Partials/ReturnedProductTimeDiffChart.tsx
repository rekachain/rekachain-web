...
export default function ({ data }: { data: PaginateResponse<ReturnedProductTimeDiffResource> }) {
    ...
    const [progressResponse, setProgressResponse] =
        useState<PaginateResponse<ReturnedProductTimeDiffResource>>(data);
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>
                                {t(
                                    'pages.dashboard.partials.returned_product_time_diff_chart.headers.year_month',
                                )}
                            </TableHead>
                            <TableHead>
                                {t(
                                    'pages.dashboard.partials.returned_product_time_diff_chart.headers.avg_duration',
                                )}
                            </TableHead>
                            <TableHead>
                                {t(
                                    'pages.dashboard.partials.returned_product_time_diff_chart.headers.total_returned',
                                )}
                            </TableHead>
                            <TableHead>
                                {t(
                                    'pages.dashboard.partials.returned_product_time_diff_chart.headers.total_problem',
                                )}
                            </TableHead>
                        </TableRow>
                    </TableHeader>
